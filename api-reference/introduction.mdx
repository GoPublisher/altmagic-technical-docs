...
2. **Share your image** either by:
   - Providing a publicly accessible URL (`image_url`), or
   - Uploading the image file directly as base64 data URI (`image_file`)
...
- Either `image_url` OR `image_file` - You must provide one of these:
